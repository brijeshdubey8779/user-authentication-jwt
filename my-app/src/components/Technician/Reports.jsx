    ...
    return (
        <div>
            ...
            <div className="reports-section p-6 bg-white rounded-lg shadow-lg">
                ...
                <table className="min-w-full table-auto border-collapse">
                    <thead className="bg-gray-100">
                        <tr>
                            ...
                            <th className="py-2 px-4 text-left text-sm font-medium text-gray-700">Report Details</th>
                    ...
                    <tbody>
                        <tr className="border-b hover:bg-gray-50">
                            ...
                            <td className="py-2 px-4 text-sm text-gray-700">2022-01-01</td>
                ...
                <button className="mt-4 bg-indigo-600 text-white py-2 px-6 rounded-md hover:bg-indigo-700 transition duration-300">Show Complete Report</button>
            </div>
        </div>
    )
}
